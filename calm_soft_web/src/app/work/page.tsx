...
// cards below can open the same case-study modal used on the homepage. Full English index of
// every case study — the homepage (CaseStudies.tsx) only shows the 3 `site.featuredCaseSlugs`
// as big cards and links here for the rest (2026-07-20 work-page-and-round2-polish design doc).
